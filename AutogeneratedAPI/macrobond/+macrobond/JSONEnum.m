classdef (Abstract) JSONEnum
    % JSONEnum Base class for enumerations when working with macrobond.JSONMapper
    % When adding enumeration properties to macrobond.JSONMapper objects, the custom
