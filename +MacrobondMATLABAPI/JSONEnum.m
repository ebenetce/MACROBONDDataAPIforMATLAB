classdef (Abstract) JSONEnum
    % JSONEnum Base class for enumerations when working with MacrobondMATLABAPI.JSONMapper
    % When adding enumeration properties to MacrobondMATLABAPI.JSONMapper objects, the custom
