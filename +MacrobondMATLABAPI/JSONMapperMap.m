classdef JSONMapperMap < handle 
    ...
    methods
        ...
        function obj = subsasgn(obj,S,B)
            ...
            if isempty(obj)
                obj = MacrobondMATLABAPI.JSONMapperMap;
            end
        ...
        function disp(obj)
            ...
            if isempty(obj)
                disp 'Empty MacrobondMATLABAPI.JSONMapperMap'
                return
            end
            fprintf('MacrobondMATLABAPI.JSONMapperMap with the following key-value pairs:\n\n');
            for k = obj.map.keys
                fprintf('\t%10s : %s\n',k{1},obj.map(k{1}));
            end
        end
