classdef Metadata < MacrobondMATLABAPI.BaseClient
    ...
    methods
        function obj = Metadata(options)
            ...
            %   client = MacrobondMATLABAPI.api.Metadata();
            %
            %   % Create a client for alternative server/base URI
            %   client = MacrobondMATLABAPI.api.Metadata("serverUri","https://example.com:1234/api/");
            %
            %   % Create a client loading configuration options from 
            %   % JSON configuration file
            %   client = MacrobondMATLABAPI.api.Metadata("configFile","myconfig.json");
            %
            %   % Create a client with alternative HTTPOptions and an API key
            %   client = MacrobondMATLABAPI.api.Metadata("httpOptions",...
        ...
        function [code, result, response] = metadataGetattributeinformationGet(obj, n)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.MetadataAttributeInformationResponse

            arguments
              obj MacrobondMATLABAPI.api.Metadata
              n string
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:metadataGetattributeinformationGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.MetadataAttributeInformationResponse(response.Body.Data);
                case 404
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        ...
                        warning("MacrobondMATLABAPI:api:metadataGetattributeinformationGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = metadataGetvalueinformationGet(obj, v)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.MetadataValueInformationResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:metadataGetvalueinformationGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.MetadataValueInformationResponse(response.Body.Data);
                case 400
                    result = response.Body.Data;
                case 404
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:metadataGetvalueinformationGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = metadataListattributevaluesGet(obj, n)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:metadataListattributevaluesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:metadataListattributevaluesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
