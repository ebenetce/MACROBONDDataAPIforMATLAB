classdef Series < MacrobondMATLABAPI.BaseClient
    ...
    methods
        function obj = Series(options)
            ...
            %   client = MacrobondMATLABAPI.api.Series();
            %
            %   % Create a client for alternative server/base URI
            %   client = MacrobondMATLABAPI.api.Series("serverUri","https://example.com:1234/api/");
            %
            %   % Create a client loading configuration options from 
            %   % JSON configuration file
            %   client = MacrobondMATLABAPI.api.Series("configFile","myconfig.json");
            %
            %   % Create a client with alternative HTTPOptions and an API key
            %   client = MacrobondMATLABAPI.api.Series("httpOptions",...
        ...
        function [code, result, response] = seriesEntityinfofordisplayGet(obj, n)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.EntityInfoForDisplayResponse

            arguments
              obj MacrobondMATLABAPI.api.Series
              n string
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesEntityinfofordisplayGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.EntityInfoForDisplayResponse(response.Body.Data);
                case 400
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        ...
                        warning("MacrobondMATLABAPI:api:seriesEntityinfofordisplayGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchallvintageseriesGet(obj, n, optionals)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.VintageSeriesResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchallvintageseriesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.VintageSeriesResponse(response.Body.Data);
                case 206
                    result = MacrobondMATLABAPI.models.VintageSeriesResponse(response.Body.Data);
                case 304
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchallvintageseriesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchallvintageseriesPost(obj, RevisionHistoryRequest)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesWithVintagesResponse

            arguments
              obj MacrobondMATLABAPI.api.Series
              RevisionHistoryRequest MacrobondMATLABAPI.models.RevisionHistoryRequest
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchallvintageseriesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchallvintageseriesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","seriesFetchallvintageseriesPost")
            end
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesWithVintagesResponse(response.Body.Data);
                case 400
                    result = response.Body.Data;
                case 401
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchallvintageseriesPost:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchentitiesGet(obj, n)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.EntityResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchentitiesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.EntityResponse(response.Body.Data);
                case 400
                    result = response.Body.Data;
                case 401
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchentitiesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchentitiesPost(obj, EntityRequest)
            ...
            arguments
              obj MacrobondMATLABAPI.api.Series
              EntityRequest MacrobondMATLABAPI.models.EntityRequest
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchentitiesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchentitiesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","seriesFetchentitiesPost")
            end
            ...
            switch (code)
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchentitiesPost:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchnthreleaseseriesGet(obj, nth, n, optionals)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesWithTimesOfChangeResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchnthreleaseseriesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesWithTimesOfChangeResponse(response.Body.Data);
                case 401
                    result = response.Body.Data;
                case 403
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchnthreleaseseriesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchobservationhistoryGet(obj, n, t)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesObservationHistoryResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchobservationhistoryGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesObservationHistoryResponse(response.Body.Data);
                case 400
                    result = response.Body.Data;
                case 404
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchobservationhistoryGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchseriesGet(obj, n)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchseriesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesResponse(response.Body.Data);
                case 400
                    result = response.Body.Data;
                case 401
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchseriesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchseriesPost(obj, EntityRequest)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchseriesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchseriesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","seriesFetchseriesPost")
            end
            ...
            switch (code)
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchseriesPost:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchunifiedseriesPost(obj, UnifiedSeriesRequest)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.UnifiedSeriesResponse

            arguments
              obj MacrobondMATLABAPI.api.Series
              UnifiedSeriesRequest MacrobondMATLABAPI.models.UnifiedSeriesRequest
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchunifiedseriesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchunifiedseriesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","seriesFetchunifiedseriesPost")
            end
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.UnifiedSeriesResponse(response.Body.Data);
                case 400
                    result = response.Body.Data;
                case 401
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchunifiedseriesPost:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesFetchvintageseriesGet(obj, t, n, optionals)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesFetchvintageseriesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesFetchvintageseriesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesGetdatapackagelistGet(obj, optionals)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.DataPackageListResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesGetdatapackagelistGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.DataPackageListResponse(response.Body.Data);
                case 403
                    result = response.Body.Data;
                case 401
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesGetdatapackagelistGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesGetrevisioninfoGet(obj, n)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesWithRevisionsInfoResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesGetrevisioninfoGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesWithRevisionsInfoResponse(response.Body.Data);
                case 401
                    result = response.Body.Data;
                case 403
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesGetrevisioninfoGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
