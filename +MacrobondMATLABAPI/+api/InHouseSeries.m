classdef InHouseSeries < MacrobondMATLABAPI.BaseClient
    ...
    methods
        function obj = InHouseSeries(options)
            ...
            %   client = MacrobondMATLABAPI.api.InHouseSeries();
            %
            %   % Create a client for alternative server/base URI
            %   client = MacrobondMATLABAPI.api.InHouseSeries("serverUri","https://example.com:1234/api/");
            %
            %   % Create a client loading configuration options from 
            %   % JSON configuration file
            %   client = MacrobondMATLABAPI.api.InHouseSeries("configFile","myconfig.json");
            %
            %   % Create a client with alternative HTTPOptions and an API key
            %   client = MacrobondMATLABAPI.api.InHouseSeries("httpOptions",...
        ...
        function [code, result, response] = seriesDeleteseriesDelete(obj, optionals)
            ...
            arguments
              obj MacrobondMATLABAPI.api.InHouseSeries
              optionals.n string
            end
            ...
            switch (code)
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        ...
                        warning("MacrobondMATLABAPI:api:seriesDeleteseriesDelete:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriesUploadseriesPost(obj, SeriesRequest)
            ...
            arguments
              obj MacrobondMATLABAPI.api.InHouseSeries
              SeriesRequest MacrobondMATLABAPI.models.SeriesRequest
            end
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriesUploadseriesPost:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
            ...
            switch (code)
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriesUploadseriesPost:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriestreeGetseriesstoragelocationsGet(obj)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesStorageLocationResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriestreeGetseriesstoragelocationsGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesStorageLocationResponse(response.Body.Data);
                case 401
                    result = response.Body.Data;
                case 403
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriestreeGetseriesstoragelocationsGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriestreeGetusedinhousecategoriesGet(obj)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriestreeGetusedinhousecategoriesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriestreeGetusedinhousecategoriesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
