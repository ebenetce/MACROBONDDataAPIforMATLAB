classdef SeriesTree < MacrobondMATLABAPI.BaseClient
    ...
    methods
        function obj = SeriesTree(options)
            ...
            %   client = MacrobondMATLABAPI.api.SeriesTree();
            %
            %   % Create a client for alternative server/base URI
            %   client = MacrobondMATLABAPI.api.SeriesTree("serverUri","https://example.com:1234/api/");
            %
            %   % Create a client loading configuration options from 
            %   % JSON configuration file
            %   client = MacrobondMATLABAPI.api.SeriesTree("configFile","myconfig.json");
            %
            %   % Create a client with alternative HTTPOptions and an API key
            %   client = MacrobondMATLABAPI.api.SeriesTree("httpOptions",...
        ...
        function [code, result, response] = seriestreeFindlocationsGet(obj, seriesName)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesTreeLocationPart

            arguments
              obj MacrobondMATLABAPI.api.SeriesTree
              seriesName string
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriestreeFindlocationsGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesTreeLocationPart(response.Body.Data);
                case 401
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        ...
                        warning("MacrobondMATLABAPI:api:seriestreeFindlocationsGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriestreeGetleafseriesGet(obj, path, optionals)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.SeriesTreeListingResponse
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriestreeGetleafseriesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.SeriesTreeListingResponse(response.Body.Data);
                case 404
                    result = response.Body.Data;
                case 401
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriestreeGetleafseriesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
        ...
        function [code, result, response] = seriestreeGetnodesGet(obj, optionals)
            ...
            %
            % See Also: MacrobondMATLABAPI.models.seriestree_getnodes_get_200_response_inner
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("MacrobondMATLABAPI:api:seriestreeGetnodesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            switch (code)
                case 200
                    result = MacrobondMATLABAPI.models.seriestree_getnodes_get_200_response_inner(response.Body.Data);
                case 401
                    result = response.Body.Data;
                case 403
                    result = response.Body.Data;
                ...
                otherwise % Unexpected output, not declared in spec
                    ...
                    if (int32(response.StatusCode) < 200 || int32(response.StatusCode) >= 300)
                        % Others will throw a warning
                        warning("MacrobondMATLABAPI:api:seriestreeGetnodesGet:UndocumentedResponse","Operation '%s' returned an undocumented response code '%d'.\n" + ...
